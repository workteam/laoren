...
<script type="text/javascript">!window.jQuery && document.write(unescape('%3Cscript src="view/javascript/jquery/jquery-1.7.1.min.js"%3E%3C/script%3E'))</script>
  ...
  <div id="menu">
    <ul class="left" style="display: none;">
      ...
      <li id='homes'>
               ...
               <ul>
                   <li><a href="?route=catalog/news&cat_id=-1&token=<?php echo $this->session->data['token'];  ?>">老人院舍管理</a></li>
               </ul>
      </li>
        <li id='activity'>
            <a class="top"> 公益活动管理</a>
            <ul>
                <li><a href="?route=catalog/news&cat_id=-2&token=<?php echo $this->session->data['token'];  ?>">公益活动管理</a></li>
            </ul>
        </li>
        <li id='shop_news'>
            <a class="top"> 商城焦点管理</a>
            <ul>
                <li><a href="?route=catalog/news&cat_id=-3&token=<?php echo $this->session->data['token'];  ?>">商城焦点管理</a></li>
            </ul>
        </li>
      ...
      <li id="help" style="display: none;"><a class="top"><?php echo $text_help; ?></a>
        <ul>
          <li><a onClick="window.open('http://www.hczm.cn');"><?php echo $text_hczm.cn; ?></a></li>
          <li><a onClick="window.open('http://www.hczm.cn/index.php?route=documentation/introduction');"><?php echo $text_documentation; ?></a></li>
          <li><a onClick="window.open('http://forum.hczm.cn.com');"><?php echo $text_support; ?></a></li>
        </ul>
      </li>
    </ul>
    <ul class="right">
