...
<link href="<?php echo Wekit::app()->themes.'/site/default/css'.Wekit::getGlobal('theme','debug'); ?>/app.css?v=<?php echo htmlspecialchars(NEXT_RELEASE, ENT_QUOTES, 'UTF-8');?>" rel="stylesheet" />
</head>
<body>
<div class="wrap">
...
<div class="tac"> </div>
	<div class="main_wrap">
		<div class="bread_crumb">
			<a href="<?php echo Wekit::app()->baseUrl,'/',''; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=appcenter'; ?>">应用中心</a>
		</div>
		<div class="main cc">
			<div class="main_body">
				<div class="main_content">
					<div class="box_wrap app_page">
						...
						<div class="ct">
							<!--无搜索动作的话search_num这组代码要隐藏掉-->
							<div class="search_num" style="display:none;">有关"<span class="org">单词学院</span>"的应用共<span class="org"><?php echo htmlspecialchars($searchCount, ENT_QUOTES, 'UTF-8');?></span>个</div>
							<ul class="cc">
...
$app['logo'] = Wekit::app()->extres . '/' . $app['alias'] . '/' . $app['logo'];
							 ...
							 ?>
 								<li>
									<a href="<?php echo htmlspecialchars($app['url'], ENT_QUOTES, 'UTF-8');?>"><img src="<?php echo htmlspecialchars($app['logo'], ENT_QUOTES, 'UTF-8');?>" onerror="this.onerror=null;this.src='<?php echo htmlspecialchars(Wind::getComponent('response')->getData('G','url','images'), ENT_QUOTES, 'UTF-8');?>/admin/yy.png'" width="80" height="80" class="img" alt="<?php echo htmlspecialchars($app['name'], ENT_QUOTES, 'UTF-8');?>" /></a>
									<div>
										...
										<p><?php echo htmlspecialchars($app['desc'], ENT_QUOTES, 'UTF-8');?></p>
										<a href="<?php echo htmlspecialchars($app['url'], ENT_QUOTES, 'UTF-8');?>" class="in">进入<em>&gt;&gt;</em></a>
									</div>
								</li>
								<?php  } ?>
							</ul>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=appcenter&orderby=', rawurlencode($orderby),'&page=', rawurlencode($_page_i); 
