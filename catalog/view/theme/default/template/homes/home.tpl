                                ...
                                <tr>
                                      <td style="padding-top: 5px;">
                                          <h2 style="font-size: 13px;border-bottom: 1px #ddd solid;padding-bottom: 5px;">
                                                 <b style="  padding-left: 5px; margin-left: 3px; ">最新老人院</b>
                                          </h2>
                                      </td>
                                </tr>
                                 <tr>
                            ...
                            <?php echo $homeszones;   ?>
                             <div style="margin: 8px 0 8px 0;">
                                 <ul id="carousel" class="jcarousel-skin-tango">
                                     ...
                                     <li>
                                           <p>
                                               <a href="<?php echo $val["href"]  ?>" target="_blank">
                                               <img title="<?php echo $val["title"]  ?>" border="0" src="<?php echo $val["thumb"]  ?>"  alt="<?php echo $val["title"]  ?>" />  <br>
                                               </a>
                                           </p>
